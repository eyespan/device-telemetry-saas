...

-----END CERTIFICATE-----"""
...
def verify_dynamodb():
    ...
    result = subprocess.run([
        'aws', 'dynamodb', 'scan',
        '--table-name', 'DeviceTelemetrySaasStack-TelemetryTableB87F4322-E0BUBBOHVTTI',
